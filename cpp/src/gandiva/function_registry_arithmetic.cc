...
std::vector<NativeFunction> GetArithmeticFunctionRegistry() {
  static std::vector<NativeFunction> arithmetic_fn_registry_ = {
      ...
      BINARY_GENERIC_SAFE_NULL_IF_NULL(lshift, {}, int32, int32, int32),
      BINARY_GENERIC_SAFE_NULL_IF_NULL(lshift, {}, int64, int64, int64),
      BINARY_GENERIC_SAFE_NULL_IF_NULL(rshift, {}, int32, int32, int32),
      BINARY_GENERIC_SAFE_NULL_IF_NULL(rshift, {}, int64, int64, int64),
      BINARY_GENERIC_SAFE_NULL_IF_NULL(rshiftunsigned, {}, int32, int32, int32),
      BINARY_GENERIC_SAFE_NULL_IF_NULL(rshiftunsigned, {}, int64, int64, int64)};
